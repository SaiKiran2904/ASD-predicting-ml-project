...
asd_child = os.path.abspath("image/asd_child.jpg")
cause_of_autism=os.path.abspath("image/causes-of-autism.png")
autism=os.path.abspath("image/autism.png")
strategies=os.path.abspath("image/Strategies.jpeg")
autism_stats_1=os.path.abspath("image/autism-stats-1.jpg")
autism_stats_2=os.path.abspath("image/autism-stats-2.png")
world=os.path.abspath("image/World.png")
worlds=os.path.abspath("image/Worlds.png")
    ...
    if session_state.login==True:
        ...
        with st.container():
            ...
            with col1:
                ...
                """)
            with col2:
                img1=Image.open(cause_of_autism)
        ...
        with st.container():
            ...
            with col2:
                img=Image.open(autism)
                st.image(img,caption="Signs of ASD")
                img1=Image.open(strategies)
        ...
        with st.container():
            ...
            with right_column:
                img=Image.open(autism_stats_1)
                st.image(img,width=350,caption="ASD ststistics")
                img1=Image.open(autism_stats_2)
